    {{-- footer --}}
    <footer>
        <div class="top-footer container mt-4">
            <div class="col-3 footer-content">
                <h3 class="h3-footer text-start pb-2">Follow Us On:</h3>
        ...
        <div class="bottom-footer">
            ...
            <div class="footer-logo">
                <a style="color:white ; display: inline-block;" class="navbar-brand " href="{{ url('/') }}"><img
                        src="{{ asset('user/images/home-images/airplane-57-48.ico') }}" style="width:50px" /> Palestine
                    <span style="color:#ff4838 ;">Tourism</span></a>
            </div>
