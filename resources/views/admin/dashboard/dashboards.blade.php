        ...
        <div class="row">
            ...
            <div class="ml-4 Dash-content col-5">
                ...
                <div class="Dash-name">
                    ...
                    <p>Every year, the list of the most attractive areas for tourists is renewed, by examining many factors,
                        the most important of which is the location itself, the services and preparations provided by the country
                         to visitors, in addition to the general atmosphere, climate, and the total cost of the trip. </p>
            ...
            <div class="Dash-content col-5 offset-1">
                ...
                <div class="Dash-name">
                    ...
                    <p>Tourism means physiotherapy, which contains natural elements that contain natural diseases that contain natural
                        diseases that contain natural diseases that contain natural diseases that contain natural diseases that contain
                        natural diseases that contain natural diseases that contain It contains physiotherapy and mineral salts that help
