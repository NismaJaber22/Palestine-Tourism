    ...
    <div class="container conta">
        <div class="Dash-div container">
            <div class="header-div">
                <h3 class="dash-header">Cultural Dashboard</h3>
            </div>
            <div class="card text-center">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link dash-link" aria-current="page"href="{{ url('ReligiousDashboard') }}">Religious</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link dash-link active" href="{{ url('CulturalDashboard') }}">Cultural</a>
                    </li>
                    <li class="nav-item">
