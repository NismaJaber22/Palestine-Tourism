                        ...
                        @foreach ($places as $place)
                            @if ($place->type == '1')
                                <tr>
                                    ...
                                    {{-- <td style="margin:auto;"><button onclick='ShowDesc(trdf)'
                                            class="btn btn-secondary btn-table"><i class="fa-solid fa-file-medical"></i></button>
                                    </td> --}}
                                    ...
                                    <td style="margin:auto;">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-table" data-bs-toggle="modal"
                                            data-bs-target="#descModal{{ $place->id }}">
                                            <i class="fa-solid fa-file-medical"></i>
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="descModal{{ $place->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="margin-top:50%">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel" style="color:orangered">Description
                                                            for {{ $place->name }}
                                                        </h1>
                                    ...
                                    {{-- image --}}
                                    <td style="margin:auto;">
                                        <button onclick='ShowImage( , Nablus)' class="btn btn-secondary btn-table"><i
                                                            ...
                                                            <label class="d-flex">
                                                                ...
                                                                <div style="width:100%">
                                                                    <input name="name" placeholder="Place Name"
                                                                        ...
                                                                        id="name" class="form-control swal2-input "
                                                                        style="width:80%" value="{{ $place->name }}" />
                                                            ...
                                                            <label class="d-flex">
                                                                ...
                                                                <div class="w-100">
                                                                    <select class="form-select"
                                                                        ...
                                                                        style="width:80%" name="type" id="type">
                                                                        <option value="1">Religious</option>
                                                                        <option value="2">Cultural</option>
                                                                        <option value="3">Leisure</option>
                                                                        <option value="4">Medical</option>
                                                            ...
                                                            <label class="d-flex">
                                                                ...
                                                                <div style="width:100%">
                                                                    <input name="Price" placeholder="Place Price"
                                                                        ...
                                                                        id="Price" class="form-control swal2-input"
                                                                        style="width:80%" value="{{ $place->Price }}" />
                                                                    <p class="pb-2 text-start pt-1" id="CostError"
                                                                        style="color:red; font-size:11px; margin:0;     font-weight: 500;">
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <label class="d-flex">
                                                                ...
                                                                <div style="width:100%">
                                                                    <input name="description"
                                                                        ...
                                                                        id="description" class="form-control swal2-input"
                                                                        style="width:80%"
                                    ...
                                    {{-- delete --}}
                                    <form name='myForm'method="post" action={{ url("admin/delete/$place->id") }}>
                                        @csrf
                                        @method('DELETE')
                                        <td style="width:10%;">
